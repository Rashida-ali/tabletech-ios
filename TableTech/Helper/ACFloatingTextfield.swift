...
fileprivate extension ACFloatingTextfield {
    ...
    func addFloatingLabel(){
        ...
        labelPlaceholder?.font = UIFont(name:"Roboto-Medium",size:14)
    ...
    func addErrorPlaceholderLabel() -> Void {
        ...
        labelErrorPlaceholder?.font = UIFont(name:"Roboto-Medium",size:14)
    ...
    func resignPlaceholder() -> Void {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            self.labelPlaceholder?.font = UIFont(name:"Roboto-Medium",size:14)
            self.labelPlaceholder?.textColor = self.placeHolderColor
            self.layoutIfNeeded()
        }) { (finished) in
